...
public enum ErrorCode {
    ...
    ROOM_NOT_FOUND(HttpStatus.NOT_FOUND, "채팅방을 찾을 수 없음"),

    INVALID_INPUT(HttpStatus.BAD_REQUEST,"입력값이 올바르지 않음"),
    MALFORMED_REQUEST(HttpStatus.BAD_REQUEST,"요청 본문을 읽을 수 없음"),
    DUPLICATE_ROOM_NAME(HttpStatus.BAD_REQUEST, "같은 이름의 채팅방이 존재함"),
    MESSAGE_TOO_LONG(HttpStatus.BAD_REQUEST,"메세지가 너무 김"),
